...
class FacultiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create faculty" do
    assert_difference('Faculty.count') do
      post faculties_url, params: { faculty: { PID: @faculty.PID, firstName: @faculty.firstName, isAdmin: @faculty.isAdmin, lastName: @faculty.lastName, sectionNumber: @faculty.sectionNumber } }
    end
  ...
  test "should update faculty" do
    patch faculty_url(@faculty), params: { faculty: { PID: @faculty.PID, firstName: @faculty.firstName, isAdmin: @faculty.isAdmin, lastName: @faculty.lastName, sectionNumber: @faculty.sectionNumber } }
